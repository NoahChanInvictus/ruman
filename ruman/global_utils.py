...
es_fans = Elasticsearch(USER_PORTRAIT_ES_HOST, timeout = 600)
...
#es for fans
fans_index_name="625_be_retweet_1"
fans_index_type='user'
...
BLACK_WORDS_PATH = '/home/lcr/ruman/ruman/cron/text_attribute/black.txt'
